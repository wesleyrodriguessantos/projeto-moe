...
<head>
  ...
  <title>Tela de atualização de Vagas - MOE</title>
...
<body class="indigo lighten-5">
  ...
  <main class="page">
    <div class="registro">
      <form action="/vagas/edit/<?= $id ?>" method="POST" data-parsley-validate>
        <div class="row">
              ...
              <div class="card-content black-text">
                ...
                <div class="row">
                  <div class="input-field">
                    ...
                    <input type="text" class="validate" name="nome_vaga" id="nome_vaga" value="<?= $vaga['nome_vaga'] ?>" maxlength="80" required>
                  </div>
                  <div class="input-field">
                    <i class="material-icons prefix">description</i>
                    <label for="descricao_vaga">Descrição sobre a Vaga <span class="required">*</span></label>
                    <textarea type="text" class="materialize-textarea validate" name="descricao_vaga" id="descricao_vaga" required><?= $vaga['descricao_vaga'] ?></textarea>
                  </div>
                  ...
                  <div class="input-field">
                    ...
                    <select for="horas" name="horas" id="horas">
                      <option value="<?= $vaga['horas'] ?>">Carga Horária Semanal = <?= $vaga['horas'] ?></option>
                  ...
                  <div class="input-field">
                    ...
                    <input type="number" class="validate" name="remuneracao" id="remuneracao" value="<?= $vaga['remuneracao'] ?>" min="787.98" step=".01" required>
                  ...
                  <div class="input-field">
                    ...
                    <input type="number" class="validate" name="semestre" id="semestre" value="<?= $vaga['semestre'] ?>" required>
                  </div>
                  <div class="input-field">
                    <i class="material-icons prefix">list</i>
                    <label for="lista_atividades">Lista de Atividadaes <span class="required">*</span></label>
                    <textarea type="text" class="materialize-textarea validate" name="lista_atividades" id="lista_atividades" required><?= $vaga['lista_atividades'] ?></textarea>
                  </div>
                  <div class="input-field">
                    <i class="material-icons prefix">list</i>
                    <label for="lista_habilidades">Lista de Habilidades <span class="required">*</span></label>
                    <textarea type="text" class="materialize-textarea validate" name="lista_habilidades" id="lista_habilidades" required><?= $vaga['lista_habilidades'] ?></textarea>
                  </div>
